...
xlswrite('result1-1.xlsx',T,'A3:A903')
xlswrite('result1-1.xlsx',Y(:,3),'B3:B903');
xlswrite('result1-1.xlsx',Y(:,1),'C3:C903');
xlswrite('result1-1.xlsx',Y(:,3)+Y(:,4)-2-xx,'D3:D903');
xlswrite('result1-1.xlsx',Y(:,1)+Y(:,2),'E3:E903');
